...
export default function Home() {
  return (
    ...
    <div><br/>Normal Routes</div>
    <div><br/><Link href={"/first"}>First Page</Link></div>
    <div><Link href={"/first/second"}>Second Page</Link></div>
    <div><Link href={"/third"}>Third Page</Link></div>
    <div><br/>Dynamic Segments</div>
    <div>
          <br/>
